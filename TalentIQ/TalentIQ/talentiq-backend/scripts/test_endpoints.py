...
ta_v2 = [
    {"Job_Req_ID": "R1", "Client_Name": "Acme", "Status": "Open", "Country": "IN",
     "Age": 12, "Primary_Skill_1": "Python", "L3_Skills": "AWS", "Grade": "3A",
     "LOB": "Data", "Vertical": "BFS", "Job_Title": "DE", "Criticality": "High"},
    {"Job_Req_ID": "R2", "Client_Name": "Globex", "Status": "Open", "Country": "US",
...
assert status["msd_allocations"]["latest"] == "2024-03"
